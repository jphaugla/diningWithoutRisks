...
import Table from "./modules/table/setTable";
...
import KitchenView from "./modules/kitchen/KitchenView";
import ServerView from "./modules/server/ServerView";
import CurrentOrders from "./modules/currentOrders/CurrentOrders";
...
export const Routes: React.SFC<RouteProps> = (childProps) =>
  <Switch>
    ...
    <Route path="/orders" exact component={CurrentOrders} />
    <Route path="/kitchen" exact component={KitchenView} />
    <Route path="/server" exact component={ServerView} />
