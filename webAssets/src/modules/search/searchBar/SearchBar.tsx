    ...
    return (
      <form className="searchform mainsearch">
        <div className="row">
          <div className="col-md-8 search-padding">
            <div className="input-group">
              ...
              <div className="input-group-btn">
                <button className="btn btn-orange no-radius" type="button" onClick={this.onSearch}>
          ...
          <h3 className="no-margin white">Search for <span className="orange">{` food `}</span>you want!</h3>
          </div>
        </div>
      </form>
    );
