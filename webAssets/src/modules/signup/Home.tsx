...
import setTable from "../../images/table.jpeg";
  ...
  renderLanding() {
    return (
      <div className="lander">
        ...
        <hr />
        <p>This is a sample application demonstrating how different types of databases and AWS services can work together to deliver a delightful user experience.  In this restaurant demo, users can browse and search for menu items, place orders, view past orders, and more.  You can get this sample application up and running in your own environment and learn more about the architecture of the app by looking at the <a href="https://github.com/aws-samples/aws-bookstore-demo-app" target="_blank">github repository</a>.</p>
  ...
  renderHome() {
    return (
      <div className="bookstore">
        ...
        <BestSellersBar />
        <div className="col-md-12">
          <div className="col-md-3 ad-padding">
            <div className="container-category no-padding">
              <LinkContainer to="/table">
                <img className="media-object large-pics" src={setTable} alt="Set Table"></img> 
              </LinkContainer>
            </div>
          </div>
          <div className="col-md-3 ad-padding">
            <div className="container-category no-padding">
              <LinkContainer to="/past">
                <img className="media-object large-pics" src={yourpastorders} alt="Past orders"></img> 
              </LinkContainer>
            </div>
          </div>
          <div className="col-md-3 ad-padding">
            <div className="container-category no-padding">
              <LinkContainer to="/cart">
                <img className="media-object large-pics" src={yourshoppingcart} alt="Shopping cart"></img> 
              </LinkContainer>
            </div>
          </div>
          <div className="col-md-3 ad-padding">
            <div className="container-category no-padding">
              <LinkContainer to="/best">
                <img className="media-object large-pics" src={bestSellers} alt="Best sellers"></img> 
              </LinkContainer>
            </div>
          </div>
        </div>
